...
/**
 * POZN. V �kolech je �ast� doimplementovat p��kaz nebo ��st metody, proto pokud se z t�to t��dy
      ...
      switch (choice) {
        case 1:
          ...
          i.performInsertQuery("INSERT INTO user " + "(email,name,surname,age,salary)"
              + "VALUES('myname123@stud.feec.vutbr.cz', 'Jon','Doe', 2014-03-11 00:00:00, 1)");
          i.performInsertQuery("INSERT INTO techStudent " + "(name,surname,dateOfBirth,mark)"
              + "VALUES('Jon','Doe', 30, 10000)");
          break;
        case 2:
        ...
        case 5:
          ...
          // dopl�te tuto metodu, tak abyjste tomuto u�ivateli zv��ili plat o 20%
