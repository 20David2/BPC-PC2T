    ...
    public static void main(String[] args)
    {
        ...
        while(proceed)  //while opakujici se do konce programu
        {
            ...
            switch(choice)  //hlavni napidka
            {
                ...
                break;
                case 11: //nacteni dat z databaze

                    try{
                        students.addAll(DBOperation.readFromDatabase());
                    } catch(Exception e)
                    {
                        System.out.println("Chyba pri nacitaci z databaze");
                    }
    
                   
                    
                break;
                case 12: //vypsani dat do databaze

                    try{

                        int delete = 0;
                        System.out.println("Chcete smazat stavajici databazi, nebo data doplnit?");
                        System.out.println("(1) Smazat a nahradit");
                        System.out.println("(2) Doplnit");
                        ...
                        if(delete == 0)
                        {
                            DBOperation.fillDatabase(students);
                        }
                        else if (delete == 1)
                        {
                            DBOperation.deleteDB();
                            DBOperation.fillDatabase(students);
                        }
                        else
                        {
                    ...
                    {
                        System.out.println("Chyba pri zapisu do databaze");
                    }
