...
public class Test {
	...
	public static void main(String[] args) {	
		...
		while(run)
		{
			...
			System.out.println("5 .. vypis databaze do konzole");
			System.out.println("6 .. vypis databaze do souboru");
			System.out.println("7 .. nacte databazi ze souboru");
			...
			switch(volba)
			{
				...
				case 4:
					...
					break;
				case 5:
					mojeDatabaze.vypisDatabazeKonzole();
					break;
				case 6:
					mojeDatabaze.vypisDatabazeSoubor();
					break;
				case 7:
					mojeDatabaze.nacteniDatabazeSoubor();
					break;						
				case 8:
					run=false;
					break;
